...
import SeverityDonutChart from '../components/ui/SeverityDonutChart';
import StatusRadialChart from '../components/ui/StatusRadialChart';
import TimeOfDayLineChart from '../components/ui/TimeOfDayLineChart';
    ...
    <div className="space-y-6 animate-fade-in no-print">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <TimeOfDayLineChart incidentes={incidentesPrepared} />

          {/* Estadísticas por operador */}
          {operatorStats.length > 0 && (
            <div className="glass-panel p-6 rounded-2xl flex flex-col transition-all hover:border-white/10 hover:shadow-lg hover:shadow-black/20">
        ...
        <div className="flex flex-col gap-4">
          <SeverityDonutChart incidentes={incidentesPrepared} />
          <StatusRadialChart incidentes={incidentesPrepared} />
