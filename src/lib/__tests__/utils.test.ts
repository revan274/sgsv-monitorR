...
describe('normalizeIncident', () => {
  ...
  it('keeps imagenEvidencia when it is an https cloud URL', () => {
    const result = normalizeIncident({ ...base, imagenEvidencia: 'https://bad.com/img.jpg' });
    expect(result.imagenEvidencia).toBe('https://bad.com/img.jpg');
  });
...
describe('normalizePersona', () => {
  ...
  it('filters imagenes to data:image/ and https cloud URLs', () => {
